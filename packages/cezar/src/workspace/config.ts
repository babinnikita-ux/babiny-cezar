...
const resourcesSchema = z
  .object({
     ...
     * typed something. It spends nothing while the downstream work is
     * genuinely pending and it finishes the work the user already asked for. `MAX_AUTO_CONTINUES` still caps a forgotten loop, and
