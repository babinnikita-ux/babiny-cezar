...
const memoryInput = () => document.querySelector<HTMLInputElement>('[data-slot="resources-memory-limit"]');
const saveMemory = () => document.querySelector<HTMLButtonElement>('[data-action="resources-save-memory"]');
