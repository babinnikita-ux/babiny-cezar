...
export function UnknownProjectRoute({
  ...
  return (
    <div data-route="unknown-project" className="flex min-h-full flex-col">
      ...
      >
        <ul
          data-slot="registered-projects"
          className="mx-auto flex w-full max-w-xs flex-col gap-1.5 text-left"
        >
          {projects.map((project) => (
            <li key={project.id}>
              ...
              >
                ...
                <span className="font-mono text-[11px] font-normal text-soft-foreground">
                  /p/{project.id}
                </span>
              </Link>
            </li>
