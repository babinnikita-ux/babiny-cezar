...
| 1 | 1.2 | Claude runner v2 emitter + golden fixtures (thinking, TodoWrite→plan, parentItemId) | done | pending |
| 1 | 1.3 | Codex runner v2 emitter + golden fixtures (items, statuses, outputDelta, todoList→plan) | done | pending |
| 1 | 1.4 | OpenCode runner v2 emitter + golden fixtures (parts, session.idle turn-end, todowrite→plan) | done | pending |
