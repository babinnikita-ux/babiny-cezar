...
|-------|------|-------|--------|--------|
| 1 | 1.1 | Full-screen /new: hero composer, pickers (workflow/skill, runner, model, variants, base), drafts | todo | — |
| 1 | 1.2 | Plan-mode toggle + plan review overlay (drag-reorder, save-as-chain, start) | todo | — |
