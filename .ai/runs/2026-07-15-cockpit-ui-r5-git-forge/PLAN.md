...
|-------|------|-------|--------|--------|
| 1 | 1.1 | Forge driver seam: src/server/forge/, health `forge` + `capabilities.localHandoff`, hosted-mode 409s | todo | — |
| 1 | 1.2 | Session git API: /api/runs/:id/changes + /files + git/commit + git/push (zod, 409-with-reason) | todo | — |
