...
| 1 | 1.6 | Files tab: read-only worktree browser (tree + preview, images inline, size caps) | done | pending |
| 1 | 1.7 | Repo view rebuild on the same components + commits/branches + mobile diff mode | done | pending |
